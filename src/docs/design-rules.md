...
1. Does an existing component already support this use case?
2. Can it be extended without breaking its intent?
3. Is the difference semantic or purely visual?
